...
binding.pry
      ...
      resp = req.post(uri.to_s, original_file.content, {
          ...
          'Content-type' => "#{original_file.mime_type};charset=utf-8",
    ...
    def connection_url
      ...
      #case
      #  when Blacklight.connection_config[:url] then Blacklight.connection_config[:ur#l]
      #  when Blacklight.connection_config["url"] then Blacklight.connection_config["u#rl"]
      #  when Blacklight.connection_config[:fulltext] then Blacklight.connection_confi#g[:fulltext]["url"]
